...
- [Email address parser discrepancies](https://portswigger.net/web-security/logic-flaws/examples#email-address-parser-discrepancies) LABS
...
For detailed information on email parsing discrepancies, including how they can be exploited, see the [Splitting the Email Atom: Exploiting Parsers to Bypass Access Controls](https://portswigger.net/research/splitting-the-email-atom) whitepaper by Gareth Heyes of the PortSwigger Research team.
